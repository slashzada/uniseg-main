...
interface MetricCardProps {
  ...
  variant?: "default" | "success" | "warning" | "destructive" | "accent"; // Added 'accent'
}
...
export function MetricCard({
  ...
  const variantStyles = {
    ...
    accent: { // Added accent styles
      icon: "bg-gradient-to-br from-accent/20 to-accent/5 text-accent",
      glow: "group-hover:shadow-[0_0_40px_-10px_hsl(var(--accent))]",
      border: "group-hover:border-accent/20",
    },
  };
